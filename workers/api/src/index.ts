 ...
 * 
 * Refactored: Routes split into modular handlers
 */
...
import { handleGetGamification, handleAwardXP, handleUpdateStreak } from './routes/gamification';
import { 
  handleGetBlocks, handleSaveBlocks, handleUpdateBlock, 
  handleGetIncompleteBlocks, handleCarryover 
} from './routes/schedule';
import { 
  handleGetJournalEntries, handleCreateJournalEntry, 
  handleUpdateJournalEntry, handleDeleteJournalEntry 
} from './routes/journal';
import { 
  handleGetUsers, handleCreateUser, handleUpdateUser, handleResetUserPin,
  handleGetGlobalStats, handleGetUserStats, handleGetAllEntries,
  handleExportUserData, handleExportAllData,
  handlePurgeUserData, handlePurgeAllData
} from './routes/admin';
